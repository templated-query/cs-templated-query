...
namespace NeuroSpeech.TemplatedQuery
{
    ...
    public static class EFExtensions2
    {
        ...
        public class DbReader : IDisposable
        {
            ...
            public static async Task<DbReader> Create(DbContext db, TemplateQuery query)
            {
            ...
            public static async Task<DbReader> CreateCommand(DbContext db, TemplateQuery query)
            {
        ...
        public static Task<List<T>> FromSql<T>(this DbContext db, string format, params object[] parameters)
            where T : class
        {
